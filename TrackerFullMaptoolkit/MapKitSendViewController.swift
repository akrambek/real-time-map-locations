//
//  MapKitSendViewController.swift
...
class MapKitSendViewController: AbstractMapKitViewController, CLLocationManagerDelegate {
    ...
    func startRecording(accuracy: CLLocationAccuracy) {
        ...
        // Initialize and add first location to array
        self.locations = [CLLocation]()
        self.coordinateList = [CLLocationCoordinate2D]()
